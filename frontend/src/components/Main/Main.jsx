      ...
      <div className="relative w-[100%] h-[100vh] overflow-hidden">
            ...
            <div className="greet-cards relative h-32 text-center top-16 lg;top-20 ">
              ...
              <div className="cards h-72 w-[100%] absolute lg:left-[50%] lg:-translate-x-[50%] mt-20 lg:mt-4 flex justify-center items-center flex-wrap gap-2 lg:gap-5 ">
                <div
                  ...
                  className="card relative transition-all text-start ease-in-out duration-300 bg-[#181B18] hover:bg-[#161816] p-5 h-36 w-36 lg:w-40 lg:h-[26vh] rounded-3xl "
                >
                ...
                <div
                  ...
                  className="card h-36 w-36 relative transition-all text-start ease-in-out duration-300 bg-[#181B18] hover:bg-[#161816] p-5 lg:w-40 lg:h-[26vh] rounded-3xl"
                >
                  <p className="text-[13px] w-24">
                    Briefly summarize this concept: urban planning.
                  </p>
                ...
                <div
                  ...
                  className="card relative h-36 w-36 transition-all text-start ease-in-out duration-300 bg-[#181B18] hover:bg-[#161816] p-5 lg:w-40 lg:h-[26vh] rounded-3xl"
                >
                  <p className="text-[13px] w-24">
                    Brainstorm team bonding activities for our work retreat.
                  </p>
                ...
                <div
                  onClick={() =>
                    loadPrompt("Tell me about React js and React native.")
                  }
                  className="card h-36 w-36 relative transition-all text-start ease-in-out duration-300 bg-[#181B18] hover:bg-[#161816] p-5 lg:w-40 lg:h-[26vh] rounded-3xl"
                >
                  <p className="text-[13px] w-24">
        ...
        <div className="prompt flex gap-5 absolute bg-[#181B18] left-[50%] -translate-x-[50%] bottom-12  lg:bottom-16 w-[87%] lg:w-[46vw] rounded-full p-3">
          <input
            ...
            value={Input}
            className="w-[90%] ml-3 border-none outline-none bg-transparent"
            type="text"
            placeholder=""
          />
        ...
        {/* <div className="absolute bottom-2 lg:opacity-0  left-[50%] -translate-x-[50%]">made by sobu</div> */}
      </div>
    </>
  );
};
